...
const OPTIONAL_COLUMNS = ['owner_instructions', 'currency', 'meta', 'phone', 'language', 'trial_started_at', 'owner_username', 'consent_at', 'consent_version', 'acquisition_source', 'acquisition_source_detail'];
