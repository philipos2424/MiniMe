...
test('counts distinct owners, not business rows', () => {
  ...
  assert.deepEqual(computeSellFunnel(taps, bizs), { tapped: 1, signedUp: 1, activated: 1, bySource: { unknown: 1 }, searchAttributed: 0 });
});
...
test('ignores businesses created before the earliest tap', () => {
  ...
  assert.deepEqual(computeSellFunnel(taps, bizs), { tapped: 1, signedUp: 0, activated: 0, bySource: { unknown: 1 }, searchAttributed: 0 });
});
...
test('attributes a business created between two taps (earliest tap wins)', () => {
  ...
  assert.deepEqual(computeSellFunnel(taps, bizs), { tapped: 1, signedUp: 1, activated: 0, bySource: { unknown: 1 }, searchAttributed: 0 });
});
...
test('never exceeds the previous step', () => {
  ...
  assert.deepEqual(f, { tapped: 2, signedUp: 2, activated: 2, bySource: { unknown: 2 }, searchAttributed: 0 });
});
...
test('handles null/empty inputs', () => {
  assert.deepEqual(computeSellFunnel(null, null), { tapped: 0, signedUp: 0, activated: 0, bySource: {}, searchAttributed: 0 });
  assert.deepEqual(computeSellFunnel([{ telegram_id: null }], []), { tapped: 0, signedUp: 0, activated: 0, bySource: {}, searchAttributed: 0 });
});
