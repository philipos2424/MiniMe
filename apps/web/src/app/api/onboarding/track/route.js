...
const VALID_STEPS = new Set([
  ...
  // Owner tapped "Skip for now" to jump straight from the Selam chat to Go Live.
  'customer_chat_skipped',
  ...
  // `trial_disclosed`: shown the 1-month trial + 1,999 ETB/mo terms on the Mode
