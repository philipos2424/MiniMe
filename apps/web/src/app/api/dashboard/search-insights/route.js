 ...
 *
 * Returns the same kind of intelligence the platform admin gets in
 * /api/admin/search-metrics, but for one business: daily appearance/click/
 * referral buckets, per-product performance, missed demand in the owner's
 * category ("people searched X and nobody had it"), language split, and
 * which queries actually converted into conversations.
 */
